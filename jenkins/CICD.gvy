    ...
    stages {
        stage('compile') {
	         steps {
                // step1 
                echo 'compiling..'
		            git url: 'https://github.com/myadamsuresh/samplejavaapp'
        ...
        stage('build & push docker image') {
	         steps {
              withDockerRegistry(credentialsId: 'DOCKER_HUB_LOGIN', url: 'https://index.docker.io/v1/') {
                    ...
                    sh script: 'docker build --file Dockerfile --tag docker.io/sureshm123456/samplejavaapp:$BUILD_NUMBER .'
                    sh script: 'docker push docker.io/sureshm123456/samplejavaapp:$BUILD_NUMBER'
              }	
           }		
        }
        stage('deploy-QA') {
